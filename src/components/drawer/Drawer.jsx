              ...
              <div className="flex h-full flex-col overflow-y-scroll bg-white py-4 shadow-xl">
                ...
                <div className="relative mt-10 flex flex-col gap-2 px-4 sm:px-6">
                  ...
                  <Link
                    href={"/Enquiry"}
                    onClick={drawerHandler}
                    className="justify-center bg-sky-900 transition duration-1000 border hover:text-gray-800 hover:bg-gray-100 hover:border-sky-600 text-gray-100 text-sm xl:text-base uppercase  py-2  px-4 rounded-md font-bold "
                  >
                    enquire
                  </Link>
                </div>
